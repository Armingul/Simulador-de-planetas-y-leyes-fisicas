...
public class Vector {
	...
	public Vector scaleVector(Vector distancia) {
		// TODO Auto-generated method stub
		Vector c = new Vector(_n);
		for (int i = 0; i < _n; i++)
			c._data[i] = distancia.getPos(i) * _data[i];
		return c;
	}
	
	public Vector divEntreVector(double distancia) {
		// TODO Auto-generated method stub
		Vector c = new Vector(_n);
		for (int i = 0; i < _n; i++)
			c._data[i] = distancia / _data[i];
		return c;
	}
	
	
	private double getPos(int i) {
		return _data[i];
